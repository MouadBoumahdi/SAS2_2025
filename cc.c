...
char checkchoix(){
    ...
    while(1){
        ...
        if (strlen(choix) != 1 || choix[0] < '0' || choix[0] > '9') {
            printf("Invalide. Réessayez.\n");
            continue;  // ask again
        }
        
        return choix[0];  // valid choice
    }
}
...
// Reads age input (1 or 2 digits), validates, returns int
// int checkage() {
//     char input[100];

//     while (1) {
//         printf("Enter age (1 or 2 digits): ");
...
//         if (len < 1 || len > 2) {
//             printf("Invalid input: please enter 1 or 2 digits.\n");
//             continue;
//         }
...
//         // Optionally check age range here if you want:
//         if (age < 0 || age > 99) {
//             printf("Invalid age: must be between 0 and 99.\n");
//             continue;
//         }
        ...
        switch (choix) {
            ...
            case '2':
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    printf("animal rah tzad fi list");
                }
                return;
...
void statistiques() {
    ...
    if (index_global == 0) {
        printf("Aucun animal dans la liste.\n");
        return;  // Exit early if no animals
    }
        ...
        switch (choix) {
            ...
            case 3: {
                ...
                for (int i = 1; i < index_global; i++) {
                    if (A[i].age > ageMax) ageMax = A[i].age;
                    if (A[i].age < ageMin) ageMin = A[i].age;
                }
            ...
            case 4: {
                int maxCount = 0;
                char especeMax[50] = "";  // Make sure this is large enough
